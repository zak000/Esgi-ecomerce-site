<div class="wrap">
	...
	<h2 id="theme-settings-title">
		...
		<?php printf(__( '%s Theme Settings', 'influence' ), $theme->get('Name')) ?>
	</h2>
	...
	<form action="options.php" method="post" id="siteorigin-settings-form" class="siteorigin-settings-form">
		...
		<p class="submit">
			<input name="Submit" type="submit" class="button-primary siteorigin-settings-submit-button" value="<?php esc_attr_e('Save Settings', 'influence'); ?>" id="siteorigin-settings-submit" />
			<input type="button" class="button-secondary siteorigin-settings-preview-button" value="<?php esc_attr_e('Preview', 'influence'); ?>" id="siteorigin-settings-main-preview" />

			<a href="http://siteorigin.com/threads/theme-<?php echo get_template() ?>/" target="_blank" id="siteorigin-theme-support"><?php _e( 'Theme Support Forum', 'influence' ) ?></a>
		</p>
	...
	<script id="settings-preview-modal-template" type="text/template">
		...
		<div id="siteorigin-settings-preview-toolbar">
			<h3><?php printf(__( '%s Theme Settings Preview', 'influence' ), $theme->get('Name')) ?></h3>
			...
			<div id="settings-tour-modal-wrapper">
				...
				<div id="settings-tour-modal">
					...
					<div id="settings-tour-step-content">
						...
						<div class="right-column">
							...
							<div class="settings-form-buttons">
								...
								<input type="button" class="button-secondary siteorigin-settings-preview" value="<?php esc_attr_e('Preview', 'influence') ?>" />
								<div class="tour-next button-secondary">
									<span data-text-continue="<?php echo esc_attr('Continue', 'influence') ?>" data-text-done="<?php echo esc_attr('Done', 'influence') ?>"><?php _e('Continue', 'influence') ?></span>
					...
					<div id="settings-tour-toolbar">
						...
						<input type="button" class="button-primary siteorigin-settings-save" value="<?php esc_attr_e('Save Settings', 'influence') ?>" />
						<input type="button" class="button-secondary siteorigin-settings-close" value="<?php esc_attr_e('Close', 'influence') ?>" />
					</div>
